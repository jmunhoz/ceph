...
OPTION(rgw_usage_log_flush_threshold, OPT_INT, 1) // threshold to flush pending log data
OPTION(rgw_usage_log_tick_interval, OPT_INT, 1) // flush pending log data every X seconds
